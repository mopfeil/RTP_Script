\documentclass[12pt,a5paper,landscape,openany.pdftex]{book}
...
\definecolor{hellgelb}{cmyk}{0,0,0.2,0}
\definecolor{headcol}{cmyk}{0,0,0.2,0}
...
%&{\large with permission by Prof. Dr.-Ing. Franz Br\"{u}mmer}\\[1cm]
&\today\\
\\
\\[5mm]
